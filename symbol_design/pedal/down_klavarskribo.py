...
def draw_down_klavarskribo(
    ...
    *,
    ...
    use_tags = list(tags) if tags is not None else ["pedal_symbol", "pedal_down"]
    ...
    # Triangle pointing down: bar at y1_mm, apex at y1_mm + dy*2
    du.add_polygon(
        [
            (x1_mm - dx*2, y1_mm),
            (x1_mm,        y1_mm + dy*2),
