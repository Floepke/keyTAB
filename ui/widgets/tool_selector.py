...
TOOL_ITEMS: list[dict] = [
    ...
    { 'name': 'dynamic',        'displayed_name': 'Dynamics',       'icon': 'dynamics',       'tooltip': 'Dynamics tool. Insert crescendo (<) and decrescendo (>) hairpins. Select the hairpin type in the toolbar, then left click to place. Drag handles to adjust time and relative pitch position. Right click a handle to delete. Double click on a handle to insert a dynamic marking (e.g., p, mf, f).' },
