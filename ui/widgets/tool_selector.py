...
TOOL_ITEMS: list[dict] = [
    ...
    { 'name': 'dynamic',        'displayed_name': 'Dynamics',       'icon': 'dynamics',       'tooltip': 'Dynamics tool. Insert crescendo (<) and decrescendo (>) hairpins, or choose dynamic mode to place standalone dynamic symbols. Hairpin mode: left click to place and drag handles to edit; right click a handle to delete. Dynamic mode: click empty space to choose and insert a symbol, click an existing symbol to edit it, drag to move, and right click to delete.' },
